# -*- coding: utf-8 -*-
#
# Capris documentation build configuration file, created by
...
latex_documents = [
    ('index', 'Capris.tex', u'Capris Documentation',
     u'Eugene Eeo', 'manual'),
]
...
man_pages = [
    ('index', 'capris', u'Capris Documentation',
     [u'Eugene Eeo'], 1)
]
...
texinfo_documents = [
    ('index', 'Capris', u'Capris Documentation',
     u'Eugene Eeo', 'Capris', 'One line description of project.',
     'Miscellaneous'),
]
